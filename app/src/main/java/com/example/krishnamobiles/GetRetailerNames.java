...
public class GetRetailerNames extends AsyncTask<String,Void,String> {
    String finalresult;
    Context context;
    AlertDialog alertDialog;
    private colorinterface mCallback;
    public   GetRetailerNames (Context ctx, colorinterface demointerface) {
        context = ctx;
    ...
    protected String doInBackground(String... params) {
        ...
        String register_url = "http://krishnadistributor.000webhostapp.com/getretailernames.php";
